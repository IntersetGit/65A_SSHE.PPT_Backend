...
function initModels(sequelize) {
  ...
  mas_procedures.belongsTo(ptt_mitigation, { as: "mitigation", foreignKey: "mitigation_id"});
  ptt_mitigation.hasMany(mas_procedures, { as: "mas_procedures", foreignKey: "mitigation_id"});
